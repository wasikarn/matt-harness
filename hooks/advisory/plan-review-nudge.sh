...
# dispatching mh:plan-reviewer for consequential plans before implementing.
...
#
# Known ceiling (mh:plan-reviewer retroactive review, 2026-07-22): the test
...
#
# Restored 2026-08-25 (revived alongside plan-reviewer/compliance-audit-nudge.sh
...
nudge = (
    "[mh:plan-review-nudge] Plan approved — if this is a consequential plan "
    "(multi-file / one-way door / unfamiliar subsystem), consider dispatching "
    "mh:plan-reviewer against the approved plan text before implementing. "
