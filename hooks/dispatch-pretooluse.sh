...
#
# Every entry in pretooluse-table.json is always on -- there is no tiering
# or kill-switch concept here at all.
#
...
# same net behavior with a single stderr note instead of one per matched gate.
set -uo pipefail
