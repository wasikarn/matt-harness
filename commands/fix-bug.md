...
- **Named model**: the reproduce → hypothesize → instrument → falsify loop is the *scientific method*. Catalog: `docs/reference/reasoning-models.md` (absolute path injected each session).
