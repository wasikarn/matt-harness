...
10. **What does the user get?** — A `~/.scratch/journal/inferential-structural-verdicts.jsonl` stream, queryable via `kbg:harness-audit --health` (or an extended `--verdicts` flag). Drift becomes visible.
