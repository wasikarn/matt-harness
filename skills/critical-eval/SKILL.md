...
**Named models** (cc-thinking-skills): *red-team* (attack the argument), *steel-manning* (cover the strongest opposing case), *debiasing* (confidence calibration). Catalog + honesty caveat: read via Bash with `cat "${KBG_PLUGIN_ROOT}/docs/reference/reasoning-models.md"`.
