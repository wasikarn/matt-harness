---
name: score-decision
description: "Score a pending decision on weighted criteria — numeric verdict, pass/fail, confidence, trace. Use when a decision needs a measurable verdict. Don't use for trivial or already-decided choices."
