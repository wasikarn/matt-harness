...
5. **Verify Fixes** — Don't re-audit your own remediation. Dispatch the `security-reviewer` agent (fresh context) via the Agent tool against the remediated files. Run static analysis if available. Confirm regression tests pass.
