...
description: Scan production readiness pre-launch. Use when asked whether an app is ready to ship. Don't use for in-flight feature work (use /mattpocock-skills:implement).
metadata:
  origin: community
model: inherit
effort: high
...
Worked ship-readiness example (68/100 verdict with blockers/fixes/evidence lists):
`reference.md#example`.
...
- Agent: `performance-optimizer` (algorithmic/complexity fixes and system-level latency diagnosis)
