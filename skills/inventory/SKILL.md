...
### Skills (46)
  ◇ adonisjs-patterns        AdonisJS v5 patterns: IoC, Lucid ORM, Japa, VineJS...
  ◇ agent-architecture-audit Scan 12-layer agent stacks, regression, memory...
  ◇ inventory                Catalogue loadable skills/agents/commands/hooks...
  ...
```
