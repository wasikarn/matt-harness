...
#
# Repointed from commands/ideate/COMMAND.md to skills/workflow/ideate/SKILL.md
...
IDEATE_CMD="$CLAUDE_DIR/skills/workflow/ideate/SKILL.md"
if [ -f "$IDEATE_CMD" ]; then
  ...
  warn "skills/workflow/ideate/SKILL.md missing — ideate port not landed"
fi
