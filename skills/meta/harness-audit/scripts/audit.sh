...
# Split-integrity guard: exactly 67 fragments, each carrying one '# N.' header,
# numbers 1..67 each exactly once. Source scope == count scope == the SAME glob
