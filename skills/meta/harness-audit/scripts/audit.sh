...
# Split-integrity guard: exactly 66 fragments, each carrying one '# N.' header,
# numbers 1..66 each exactly once. Source scope == count scope == the SAME glob
