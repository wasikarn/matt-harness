...
# sourced nor counted. Three assertions close the fail-OPEN holes a single
# equality check misses: a fragment with no header (files != headers), a
# duplicate number (total != unique), and a gap/loss (unique set != expected).
# Any = err_die.
