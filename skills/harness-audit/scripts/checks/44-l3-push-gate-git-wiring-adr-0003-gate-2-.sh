...
# RETIRED 2026-06-25 (ADR 0004 Gate-2 + ADR 0005 L5; replaced by block-dangerous-
...
# (NOT on ADR 0003/0005) — the gauntlet_run-emit + core.hooksPath guards stay
...
# the L5 leg is dead. Gated on the gauntlet FILE being present (not on ADR 0005).
...
# Gated on the git-hooks/ dir being present (not on ADR 0003/0005).
...
info "audit #44: push-gate + post-push tripwire legs RETIRED 2026-06-25 (ADR 0006 supersedes 0003/0005); gauntlet_run-emit + core.hooksPath guards re-gated on file presence" 2>/dev/null || true