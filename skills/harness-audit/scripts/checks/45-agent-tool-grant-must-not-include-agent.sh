#!/usr/bin/env bash
# 45. Agent tool-grant must not include Agent (Rule 13 one-level-deep dispatch). No agent in
# this fleet spawns further subagents — Rule 13 (CLAUDE.md §Staff-Engineer Thinking Loop) is
