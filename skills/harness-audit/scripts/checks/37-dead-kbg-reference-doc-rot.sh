#!/usr/bin/env bash
# 37. Dead `kbg:<name>` reference doc-rot (a surface or doc names a `kbg:`
...
# repo-wide extraction) unlike bare scaffold words (which would need a rule
# excluding common false-positive terms) — a general regex is safe here.
