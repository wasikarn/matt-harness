#!/usr/bin/env bash
# 55. mattpocock-skills integration refs — kbg routes to matt's fleet by
...
# 2026-08-10 by the survey that built this check — checks 25/40 structurally
# could not see it: 25 reads only agents' `skills:` YAML arrays, 40 only
