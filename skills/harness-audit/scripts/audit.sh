...
# Split-integrity guard: exactly 46 fragments, each carrying one '# N.' header,
# numbers 1..46 each exactly once. Source scope == count scope == the SAME glob
