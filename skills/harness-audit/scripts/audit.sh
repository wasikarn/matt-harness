...
# Split-integrity guard: exactly 49 fragments, each carrying one '# N.' header,
# numbers 1..49 each exactly once. Source scope == count scope == the SAME glob
