...
# Split-integrity guard: exactly 43 fragments, each carrying one '# N.' header,
# numbers 1..43 each exactly once. Source scope == count scope == the SAME glob
