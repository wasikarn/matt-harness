...
# Split-integrity guard: exactly 55 fragments, each carrying one '# N.' header,
# numbers 1..55 each exactly once. Source scope == count scope == the SAME glob
...
# (total != unique), and a gap/loss (unique set != 1..55). Any = err_die.
