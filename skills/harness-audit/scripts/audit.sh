...
# Split-integrity guard: exactly 47 fragments, each carrying one '# N.' header,
# numbers 1..47 each exactly once. Source scope == count scope == the SAME glob
