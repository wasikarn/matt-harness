...
# Split-integrity guard: exactly 48 fragments, each carrying one '# N.' header,
# numbers 1..48 each exactly once. Source scope == count scope == the SAME glob
