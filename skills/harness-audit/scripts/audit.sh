...
# Split-integrity guard: exactly 44 fragments, each carrying one '# N.' header,
# numbers 1..44 each exactly once. Source scope == count scope == the SAME glob
