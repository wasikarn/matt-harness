...
# Split-integrity guard: exactly 50 fragments, each carrying one '# N.' header,
# numbers 1..50 each exactly once. Source scope == count scope == the SAME glob
