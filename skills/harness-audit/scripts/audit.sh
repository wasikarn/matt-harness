...
# Split-integrity guard: exactly 35 fragments, each carrying one '# N.' header,
# numbers 1..35 each exactly once. Source scope == count scope == the SAME glob
