...
# Split-integrity guard: exactly 37 fragments, each carrying one '# N.' header,
# numbers 1..37 each exactly once. Source scope == count scope == the SAME glob
