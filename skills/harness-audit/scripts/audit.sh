...
# Split-integrity guard: exactly 45 fragments, each carrying one '# N.' header,
# numbers 1..45 each exactly once. Source scope == count scope == the SAME glob
