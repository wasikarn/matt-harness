...
# (#31 follows #33), so glob-sourcing by 01..51 filename sort reproduces the
...
# Split-integrity guard: exactly 51 fragments, each carrying one '# N.' header,
# numbers 1..51 each exactly once. Source scope == count scope == the SAME glob
