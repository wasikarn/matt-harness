...
- `intentional_gap` — a known deliberate gap, annotated in the
  ...
  the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model L115).
...
- A cell with `status == intentional_gap` is *not* a decay candidate,
  ...
  deliberately empty per Bockeler L465-L478 and the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model L115.
...
- **1 intentional gap** (`inf-fb-behaviour`) — Bockeler
  ...
  all advisory-only per the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model L115. This is *not* a coverage
...
- Does **not** emit any blocking or gating decision (no
  ...
  §4(c) and the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model §L115).
...
- Does **not** run on a scheduled timer or unattended loop. The
  ...
  (`CLAUDE.md` § "The autonomy invariant" + the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model) forbids
...
- **Autonomy invariant:** `CLAUDE.md` § "The autonomy invariant"
  + `the no-model-self-start rule in METHODOLOGY.md and CLAUDE.md §The operating model`. This skill is read-only advisory; the operator
