...
description: Catalog of UI-polish details — spacing, borders, shadows, motion, hit areas, text wrapping. Use when a UI feels flat. Don't use for overall direction choices.
metadata:
...
- Direction-setting comes first (the former `mh:frontend-design-direction` skill was deleted
  2026-09-01 — use the installed plannotator/artifact-design skills or plain design judgment);
  this skill polishes the details once components already exist.
