---
name: search-first
description: Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Invokes the researcher agent. Use when starting a new feature that may have existing solutions. Don't use for trivial changes with no plausible existing tool.
metadata:
  origin: ECC
---
