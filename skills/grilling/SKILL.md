---
name: grilling
description: "Relentless interview to stress-test a plan or design. Modes: basic (default, interview only) or with-docs (also produces ADRs + domain glossary). Use when the user wants to challenge a plan, design, or assumption before committing. Don't use for already-decided or exploratory back-of-napkin sketches."
---
