...
description: Design task-local harnesses, eval gates, and reusable skill extraction for Claude dynamic workflow mode and other adaptive agent harnesses. Use when designing or implementing custom agent harnesses, eval gates, or skill extraction flows. Don't use for static one-shot commands.
metadata:
  origin: ECC
---
