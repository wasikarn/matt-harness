...
### 32.1 Anti-Fabrication 3-Tier Tree (v2.2 — from research-brief-FINAL §3)
...
**Hedge budget (hard rule, from research-brief-FINAL §3.1):** คนจริงเขียน ≤1 hedge per clause. ถ้าเขียน >1 hedge ใน clause เดียว → drop เป็น T1 แทน.
...
**Honest-broker preamble (cut to claim, from research-brief-FINAL §3.4):** ห้ามขึ้นประโยค `ผมไม่โทษเครื่องมือ แต่...` / `ต้องบอกว่า...` / `จริงๆ แล้ว...` ก่อน claim. ไปที่ claim เลย.
...
### 32.2 Red-Flag Patterns Catalog (v2.2 — from research-brief-FINAL §3.2)
...
### 32.6 Epistemic Frame — Self-Aware Uncertainty (v2.2 — from research-brief-FINAL §3.6)
...
**Red-flag connectors (v2.2 — from research-brief-FINAL §1):**
