...
description: "Dart/Flutter production patterns: null safety, state management (BLoC/Riverpod/Provider), GoRouter, Dio, Freezed, clean architecture. Use when building or reviewing Dart/Flutter apps. Don't use for web-only frontend."
metadata:
  origin: ECC
---
...
GoRouter's reactive auth-redirect pattern and Riverpod's derived-provider pattern are covered in full in §7 and §6 below.
