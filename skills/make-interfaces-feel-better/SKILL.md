...
description: Concrete UI-polish details, covering spacing, borders, shadows, motion, hit areas, text wrapping. Use when a UI feels flat. Don't use for direction choices (kbg:frontend-design-direction).
metadata:
