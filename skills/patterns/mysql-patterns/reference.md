...
Full SQL/code for every pattern summarized in `SKILL.md`'s trigger map. Content moved verbatim
from SKILL.md (2026-08-23, 200-LOC cap refactor) — the qualifiers here are load-bearing; edit
them here, not by re-deriving from memory.
