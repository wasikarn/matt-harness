...
Then, after the chosen matrix places each grouped item, run `routing.md`'s Step 0.5 route rubric (inputs I1–I7 → execution shape) before filling its Route cell.
