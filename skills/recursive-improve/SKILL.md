...
See `references/output-format-disambiguation.md` for how to fill `not-done`,
`routed_to_ship`, `dropped`, and `drift_guard: n/a` correctly — these four fields
are easy to conflate, and the reference disambiguates each with a worked case.
