...
description: "Change existing behavior: update tests to new spec, fix implementation to match, review, gated commit. Use when behavior is not broken but should be different. Don't use for broken behavior (use orch-fix-defect) or new capabilities (use orch-add-feature)."
metadata:
  origin: ECC
---
