...
description: Diagnose and fix React build failures across Vite, webpack, Next.js, CRA, and Bun. Handles compile errors, hydration mismatches, server/client boundary failures, and bundler configuration issues.
