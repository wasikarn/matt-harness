...
description: "Expert Django reviewer: ORM correctness, DRF patterns, migration safety, security misconfigurations, and production-grade practices. MUST BE USED for Django projects."
