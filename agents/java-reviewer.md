---
name: java-reviewer
description: "Expert Java reviewer for Spring Boot and Quarkus: layered architecture, JPA/Panache, MongoDB, security, and concurrency. MUST BE USED for all Java changes."
