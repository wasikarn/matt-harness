...
description: "Java/Maven/Gradle build error resolver for Spring Boot and Quarkus. Fixes build errors, compiler errors, and dependency issues. Use when Java builds fail."
