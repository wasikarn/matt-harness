...
description: Fixes measured bottlenecks, bundle size, memory leaks, render churn. Use with a profile or repro, or an audit; not for speculative tuning or cyclomatic complexity.
bucket: build
