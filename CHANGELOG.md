...
- `scripts/run-gauntlet.sh` — batch shellcheck into one invocation (whitespace-safe `mapfile` arg expansion). Long-pole of the gauntlet: ~1.0s saved (~1960ms → ~940ms over 65 .sh files).
