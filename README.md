...
[![Version](https://img.shields.io/badge/version-v0.68.342-blue)](CHANGELOG.md)
...
|---|---|---|
| **Skills** | 41 | `kbg:<skill>` — e.g. `kbg:pr`, `kbg:orchestrate` (matt-origin skills install as a separate namespaced plugin — e.g. `mattpocock-skills:grilling`) |
| **Agents** | 20 | Spawned by Claude or via the `Task` tool — e.g. `code-architect` |
| **Commands** | 25 | `/kbg:<command>` — e.g. `/kbg:ship`, `/kbg:address-review`, `/kbg:fix-bug` (namespaced identically to skills — see Quick Start step 7) |
...
> `ls commands/` (real current fleet: 41 skills · 20 agents · 25 commands).
...
| kbg-native | MIT | 41 skills · 20 agents · 25 commands |
