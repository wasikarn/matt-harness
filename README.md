...
[![Version](https://img.shields.io/badge/version-v0.68.487-blue)](CHANGELOG.md)
...
claude plugin details mh@kobig   # component inventory + token cost — use step 7's
                                   # smoke test for a real functional check
```
...
> (commands/ retired as a surface type 2026-08-25, #112 — real current fleet: 58 skills · 17 agents).
