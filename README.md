...
[![Version](https://img.shields.io/badge/version-v0.68.477-blue)](CHANGELOG.md)
...
|---|---|---|
| **Skills** | 49 | `mh:<skill>` — e.g. `mh:pr`, `mh:orchestrate` (matt-origin skills install as a separate namespaced plugin — e.g. `mattpocock-skills:grilling`) |
| **Agents** | 16 | Spawned by Claude or via the `Task` tool — e.g. `code-architect` |
| **Commands** | 8 | `/mh:<command>` — e.g. `/mh:ship-release`, `/mh:frame` (namespaced identically to skills — see Quick Start step 7; shrinking as the commands→skills convergence lands, spec #101) |
...
> `ls commands/` (real current fleet: 49 skills · 16 agents · 8 commands).
...
| kbg-native | MIT | 49 skills · 16 agents · 8 commands |
