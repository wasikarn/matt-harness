...
[![Version](https://img.shields.io/badge/version-v0.68.371-blue)](CHANGELOG.md)
...
|---|---|---|
| **Skills** | 51 | `kbg:<skill>` — e.g. `kbg:pr`, `kbg:orchestrate` (matt-origin skills install as a separate namespaced plugin — e.g. `mattpocock-skills:grilling`) |
...
> `ls commands/` (real current fleet: 51 skills · 20 agents · 25 commands).
...
| kbg-native | MIT | 51 skills · 20 agents · 25 commands |
