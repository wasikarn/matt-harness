...
[![Version](https://img.shields.io/badge/version-v0.68.451-blue)](CHANGELOG.md)
...
|---|---|---|
| **Skills** | 46 | `kbg:<skill>` — e.g. `kbg:pr`, `kbg:orchestrate` (matt-origin skills install as a separate namespaced plugin — e.g. `mattpocock-skills:grilling`) |
...
> `ls commands/` (real current fleet: 46 skills · 18 agents · 22 commands).
...
| kbg-native | MIT | 46 skills · 18 agents · 22 commands |
