...
[![Version](https://img.shields.io/badge/version-v0.68.346-blue)](CHANGELOG.md)
...
|---|---|---|
| **Skills** | 43 | `kbg:<skill>` — e.g. `kbg:pr`, `kbg:orchestrate` (matt-origin skills install as a separate namespaced plugin — e.g. `mattpocock-skills:grilling`) |
...
> `ls commands/` (real current fleet: 43 skills · 20 agents · 25 commands).
...
| kbg-native | MIT | 43 skills · 20 agents · 25 commands |
