...
| security-scan | Scan agent, hook, MCP, permission, and secret surfaces via AgentShield. Use when auditing harness/agent surfaces. Don't use for code-vulnerability review — use mh:security-auditor. | inline | auto |
