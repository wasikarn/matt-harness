...
### Skills (47)
  ...
  ◇ score-decision                 Score a pending decision on weighted criteria — numeric verdict, pass/fail, confidence, trace. Use when a decision needs a measurable verdict. Don't use for trivial or already-decided choices.
...
| score-decision | Score a pending decision on weighted criteria — numeric verdict, pass/fail, confidence, trace. Use when a decision needs a measurable verdict. Don't use for trivial or already-decided choices. | inline | manual |
...
---
_Generated: 2026-06-30T14:10:15Z_
