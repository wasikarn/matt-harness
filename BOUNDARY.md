...
### Skills (47)
  ...
  ◇ setup-matt-pocock-skills       One-time bootstrap — map matt-pocock skills to your project (tracker, labels, ADR format). Use when onboarding. Don't use for re-running on an already-configured repo.
...
| setup-matt-pocock-skills | One-time bootstrap — map matt-pocock skills to your project (tracker, labels, ADR format). Use when onboarding. Don't use for re-running on an already-configured repo. | inline | manual |
...
---
_Generated: 2026-06-30T14:52:28Z_
