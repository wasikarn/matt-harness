...
| `scripts/evals/run-acceptance.py` | Deterministic acceptance runner against locked `ACCEPTANCE.md` contracts. 5 exit codes (PASS/FAIL/INVOCATION/PARSE/BLOCK). | Any `/ship-task` acceptance verification change |
