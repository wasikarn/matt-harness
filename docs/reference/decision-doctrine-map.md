...
| Task prompt → dispatch | `docs/reference/task-handoff-template.md` (9-field handoff template) + `kbg:orchestrate`'s F9 spawn-prompt discipline — the dedicated prep skill + fresh-context checker agent were retired 2026-08-24 (#78) |
