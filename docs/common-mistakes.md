...
```bash
grep -c "^## Done-when" "${MH_PLUGIN_ROOT}/skills/workflow/orchestrate/reference.md"
```
...
```bash
grep -c "^## Validation chain" "${MH_PLUGIN_ROOT}/skills/workflow/orchestrate/reference.md"
```
