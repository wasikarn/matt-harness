---
name: ship-release
description: "self-test fixture — the safety flag is deliberately OMITTED so check 63 fires CRIT"
---

# ship release

Fixture body. The disable-model-invocation frontmatter flag is missing on purpose so
check 63 finds it absent and emits a CRIT. Do not add that flag to this fixture —
