...
check gates/validator-bash-guard.sh deny "code-reviewer + backtick indirection bash"   "$(validator_bash_event 'code-reviewer' '`which bash` -c \"echo pwn\"')"   "$(validator_bash_event 'code-reviewer' '\`which bash\` -c "echo pwn"')"
